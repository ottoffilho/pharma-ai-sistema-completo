// Dashboard Operacional - Pharma.AI
...
/**
 * Dashboard Operacional - Acesso para Farmacêuticos
 */
export const DashboardOperacional: React.FC<DashboardProps> = ({ usuario, permissoes }) => {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-900">Produção</p>
                      <p className="text-xs text-gray-500">Ordens, Manipulação</p>
                    </div>
                  </div>
                </a>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-500">Análises, Laudos</p>
                    </div>
                  </div>
                </a>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-500">Insumos, Lotes</p>
                    </div>
                  </div>
                </a>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-500">Avaliação, Aprovação</p>
                    </div>
                  </div>
                </a>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-500">Produtividade do Mês</div>
                </div>
